...
/**
 * Webftp preference manager
 *
 * @package		Todoyu
 * @subpackage	Webftp
 */
class TodoyuWebftpPreferences {
	...
	public static function savePref($preference, $value, $idItem = 0, $unique = false, $idArea = 0, $idPerson = 0) {
		TodoyuPreferenceManager::savePreference(EXTID_WEBFTP, $preference, $value, $idItem, $unique, $idArea, $idPerson);
	}
	...
	public static function getPref($preference, $idItem = 0, $idArea = 0, $unserialize = false, $idPerson = 0) {
		return TodoyuPreferenceManager::getPreference(EXTID_WEBFTP, $preference, $idItem, $idArea, $unserialize, $idPerson);
	}
	...
	public static function getPrefs($preference, $idItem = 0, $idArea = 0, $idPerson = 0) {
		return TodoyuPreferenceManager::getPreferences(EXTID_WEBFTP, $preference, $idItem, $idArea, $idPerson);
	}
	...
	public static function getActiveTab() {
		...
		if( empty($tab) ) {
			$tab = Todoyu::$CONFIG['EXT']['webftp']['defaultTab'];
		}
