 ...
 */
class TodoyuWebftpPanelWidgetFileoperation extends TodoyuPanelWidget {
	...
	public function renderContent() {
		$tmpl	= 'ext/webftp/view/panelwidget-fileoperation.tmpl';
